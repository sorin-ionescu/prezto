...
if [[ "$KEYMAP" == (emacs|) ]]; then
  ...
  bindkey -M vicmd "${keys[Control]}M" vi-accept-line
  ...
  bindkey -M vicmd -M viins "${keys[Control]}u" undo
  bindkey -M vicmd -M viins "${keys[Control]}r" redo
  ...
  # Emacs key bindings.
  bindkey -M vicmd -M viins "${keys[Control]}a" beginning-of-line
  bindkey -M vicmd -M viins "${keys[Control]}b" backward-char
  bindkey -M vicmd -M viins "${keys[Escape]}b" emacs-backward-word
  bindkey -M vicmd -M viins "${keys[Control]}d" delete-char-or-list
  bindkey -M vicmd -M viins "${keys[Escape]}d" kill-word
  bindkey -M vicmd -M viins "${keys[Control]}e" end-of-line
  bindkey -M vicmd -M viins "${keys[Control]}f" forward-char
  bindkey -M vicmd -M viins "${keys[Escape]}f" emacs-forward-word
  bindkey -M vicmd -M viins "${keys[Control]}k" kill-line
  bindkey -M vicmd -M viins "${keys[Control]}u" backward-kill-line
  bindkey -M vicmd -M viins "${keys[Control]}w" backward-kill-word
  bindkey -M vicmd -M viins "${keys[Escape]}w" copy-region-as-kill
  bindkey -M vicmd -M viins "${keys[Escape]}${keys[Left]}" emacs-backward-word
  bindkey -M vicmd -M viins "${keys[Escape]}${keys[Right]}" emacs-forward-word
